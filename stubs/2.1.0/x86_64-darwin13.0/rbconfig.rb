...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/boxen/rbenv/versions/2.1.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/boxen/rbenv/versions/2.1.2' '--with-openssl-dir=/opt/boxen/homebrew/opt/openssl' '--with-readline-dir=/opt/boxen/homebrew/opt/readline' 'CFLAGS=-I/opt/boxen/homebrew/include -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/opt/boxen/rbenv/versions/2.1.2/lib -L/opt/boxen/homebrew/lib' 'CPPFLAGS=-I/opt/boxen/rbenv/versions/2.1.2/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/boxen/rbenv/versions/2.1.2"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/boxen/rbenv/versions/2.1.2/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/opt/boxen/rbenv/versions/2.1.2/lib -L/opt/boxen/homebrew/lib -fstack-protector -L/usr/local/lib"
  CONFIG["CFLAGS"] = "-I/opt/boxen/homebrew/include -O3 -Wno-error=shorten-64-to-32  -pipe"
  CONFIG["CC"] = "gcc-4.2"
  ...
  CONFIG["host_os"] = "darwin13.1.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin13.1.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin13.1.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin13.1.0"
  CONFIG["RUBY_RELEASE_DATE"] = "2014-05-08"
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.1.2"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = ""
  CONFIG["LIBS"] = "-lpthread -lgmp -ldl -lobjc"
  CONFIG["ECHO_T"] = ""
  CONFIG["ECHO_N"] = ""
  CONFIG["ECHO_C"] = "\\\\c"
  CONFIG["DEFS"] = ""
